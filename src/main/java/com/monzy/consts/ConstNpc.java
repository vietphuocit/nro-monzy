...
public class ConstNpc {
  ...
  public static final String CALICK_KE_CHUYEN =
      "20 năm trước bọn Android sát thủ đã đánh bại nhóm bảo vệ trái đất của Sôngoku và Cađíc, Pôcôlô ...\b"
  ...
  public static final String HUONG_DAN_DOANH_TRAI =
      "1) Trại độc nhãn là nơi các ngươi không nên vào vì những tướng tá rất mạnh. Hahaha\b"
  ...
  public static final String HUONG_DAN_BLACK_BALL_WAR =
      "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\b"
  ...
  public static final String HUONG_DAN_MAP_MA_BU =
      "Mỗi ngày từ 12h đến 13h tại đại hội võ thuật sẽ xảy ra 1 cuộc đại chiến\b"
  ...
  public static final String HUONG_DAN_DOI_SKH_VIP =
      "Nguyên liệu cần để làm SKH VIP là :\b"
  ...
  public static final String HUONG_DAN_CAY =
      "Cách để bạn có 1 lượng vàng lớn :\b"
  ...
  public static final String HUONG_DAN_MO_THANH_VIEN =
      "Hướng dẫn mở thành viên tự động\b"
          ...
          + "3. Sau khi chuyển khoản vui lòng chờ 3-5p.";
  public static final String HUONG_DAN_SK =
      "Cách Làm Sự Kiện :\b"
  ...
  public static final String HUONG_DAN_SK_HE =
      "Sự kiện hè 2023 diễn ra từ 14/7/2023 - 31/8/2023: :\b"
          + "Công thức đổi:\b"
  ...
  public static final String NPC_DHVT23 = "Đại hội quy tụ nhiều cao thủ như là Jacky CHun, Thiên Xin Hăng, Tàu Bảy Bảy... Phần thường là 1 rương gỗ chưa nhiều vật phẩm giá trị. Khi hạ được 1 đối thủ, phần thưởng sẽ nâng lên 1 cấp. Rương càng cao cấp, vật phaarm trong đó càng giá trị hơn.\b" + "Mỗi ngày bạn chỉ được nhận 1 phần thưởng. Bạn hãy cố gắng hết sức mình để nhận phần thưởng xứng đáng nhất nhé..\b";
