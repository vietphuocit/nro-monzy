...
public class ConstNpc {
  ...
  public static final String HUONG_DAN_BLACK_BALL_WAR =
      "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\n"
  ...
  public static final String HUONG_DAN_MAP_MA_BU =
      "Mỗi ngày từ 12h đến 13h tại đại hội võ thuật sẽ xảy ra 1 cuộc đại chiến\n"
  ...
  public static final String HUONG_DAN_DOI_SKH_VIP =
      "Nguyên liệu cần để làm SKH VIP là :\n"
  ...
  public static final String HUONG_DAN_CAY =
      "Cách để bạn có 1 lượng vàng lớn :\n"
  ...
  public static final String HUONG_DAN_NAP_TU_DONG =
      "Hướng dẫn nạp tự động\n"
          + "Chuyển khoản Momo: 0367850360 hoặc MB Bank: 0583217667.\n"
          + "Với nội dung: nap ten_nhan_vat\n"
          + "Ví dụ: nap monzy\n"
          + "LƯU Ý:\n"
          + "1. Tối thiểu 10k VND.\n"
          + "2. Sai cú pháp sẽ không được cộng tiền vào tài khoản.\n"
          + "3. Sau khi chuyển khoản vui lòng chờ 3-5p.";
  public static final String HUONG_DAN_MO_THANH_VIEN =
      "Hướng dẫn mở thành viên tự động\n"
          + "Chuyển khoản Momo: 0367850360 hoặc MB Bank: 0583217667.\n"
          + "Nội dung chuyển khoản: mtv ten_nhan_vat\n"
          + "Ví dụ: mtv monzy\n"
          + "LƯU Ý:\n"
          + "1. Mở thành viên với phí 20k.\n"
          + "2. Sai nội dung sẽ không thể mở thành viên.\n"
          + "3. Sau khi chuyển khoản vui lòng chờ 3-5p.";
  ...
  public static final String HUONG_DAN_SK_HE =
      "Sự kiện hè 2023 diễn ra từ 14/7/2023 - 31/8/2023: :\n"
          + "Công thức đổi:\n"
          + "THỨC ĂN: 1 TRÁI DỪA.\n"
          + "Ngẫu nhiên 1 trong 3 (Cua rang me, Bạch tuộc nướng, Tôm tẩm bột chiên xù)\n\n"
          + "PET: 10 CON CUA + 10 SAO BIỂN.\n"
