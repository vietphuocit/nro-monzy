...
//        }
    ...
    public static void readmob(int zoomlv, int mob) {
        ...
        byte[] data = null;
        try {
            DataInputStream dis = new DataInputStream(new FileInputStream("data/monzy/mob/x" + zoomlv + "/" + mob));
...
//    }
    ...
    public static void readEff(int id, int zoom) {
        try {
            DataInputStream dis = new DataInputStream(new FileInputStream("data/monzy/effdata/x" + zoom + "/" + id));
