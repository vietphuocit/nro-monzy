...
import com.monzy.models.Template.SkillTemplate;
...
public class SkillUtil {
  ...
  public static boolean isUseSkillDam(Player player) {
    ...
    return (skillId == Skill.DRAGON
        || skillId == Skill.DEMON
        || skillId == Skill.GALICK
        || skillId == Skill.KAIOKEN
  ...
  public static int getHPMobMe(
      int hpMaxPlayer, int level) { // lấy hp max của đệ trứng theo hp max player
