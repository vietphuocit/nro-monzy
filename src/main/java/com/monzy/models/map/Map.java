...
public class Map implements Runnable {
  ...
  private void initItem() {
    for (Zone zone : zones) {
      switch (this.mapId) {
        case 21:
	        new ItemMap(zone, 74, 1, 633, 315, -1);
          break;
        case 22:
	        new ItemMap(zone, 74, 1, 56, 315, -1);
          break;
        case 23:
	        new ItemMap(zone, 74, 1, 633, 320, -1);
          break;
        case 42:
	      case 44:
		      new ItemMap(zone, 78, 1, 70, 288, -1);
          break;
        case 43:
	        new ItemMap(zone, 78, 1, 70, 264, -1);
          break;
	      case 85: //1 sao đen
