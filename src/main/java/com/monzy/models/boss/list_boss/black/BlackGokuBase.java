...
public class BlackGokuBase extends Boss {
  ...
  //            if (Util.isTrue(1, 20)) {
  //                Service.gI().dropItemMap(this.zone, new ItemMap(zone, 16, 1, this.location.x,
  ...
  // Manager.itemIds_NR_SB[randomNR], 1, this.location.x, zone.map.yPhysicInTop(this.location.x,
