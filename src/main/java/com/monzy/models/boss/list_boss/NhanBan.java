...
public class NhanBan extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        ItemMap it = new ItemMap(this.zone, Util.nextInt(1099, 1103), Util.nextInt(3, 4), this.location.x, this.zone.map.yPhysicInTop(plKill.location.x, plKill.location.y), plKill.id);
