  ...
  public void reward(Player plKill) {
    ...
    if (TaskService.gI().isCurrentTask(plKill, ConstTask.TASK_31_2) && this.name.equals("Zamasu"))
      Service.gI()
          .dropItemMap(
              this.zone,
              new ItemMap(this.zone, 874, 1, plKill.location.x, plKill.location.y, plKill.id));
    else if (TaskService.gI().isCurrentTask(plKill, ConstTask.TASK_31_3)
        && this.name.equals("Thần Zamasu"))
      Service.gI()
          .dropItemMap(
              this.zone,
              new ItemMap(this.zone, 725, 1, plKill.location.x, plKill.location.y, plKill.id));
  }
