...
public class MagicTree {
  ...
  private static final int[][][] POS_PEAS = {
    ...
    {
      {3, 44}, {21, 49}, {25, 39}, {4, 30}, {29, 25}, {0, 18}, {21, 15}, {14, 39}, {18, 25}, {4, 7},
      {15, 0}
    },
    {
      {21, 58}, {0, 56}, {18, 48}, {10, 0}, {25, 38}, {0, 26}, {14, 28}, {25, 16}, {1, 14}, {22, 7},
      {10, 14}, {28, 23}, {15, 16}
    },
    {
    ...
    {
      {32, 86}, {5, 77}, {25, 77}, {8, 89}, {29, 68}, {4, 63}, {18, 61}, {33, 53}, {8, 48},
      {26, 39}, {11, 36}, {33, 23}, {18, 25}, {4, 20}, {26, 12}, {12, 7}, {19, 0}, {19, 0}, {19, 0}
    },
    {
      {32, 86}, {5, 77}, {25, 77}, {8, 89}, {29, 68}, {4, 63}, {18, 61}, {33, 53}, {8, 48},
      {26, 39}, {11, 36}, {33, 23}, {18, 25}, {4, 20}, {26, 12}, {12, 7}, {19, 0}, {19, 0}, {19, 0},
  ...
  public void upgradeMagicTree() {
    ...
    if (this.player.inventory.gold < goldRequire) {
      Service.gI()
          .sendThongBao(
              player,
              "Bạn không đủ vàng để nâng cấp, còn thiếu "
                  + (goldRequire - this.player.inventory.gold)
                  + " vàng nữa");
    } else {
  ...
  public int addPeaHarvest(byte level, int quantity) {
    ...
    pea.itemOptions.add(
        new Item.ItemOption(level - 1 > 1 ? 2 : 48, MagicTree.PEA_PARAM[level - 1]));
