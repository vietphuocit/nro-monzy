...
//        switch (typeWin) {
//            case PVP.TYPE_DIE:
//                Service.getInstance().sendThongBao(winer, "Đối thủ đã kiệt sức, bạn thắng được đi
// vào vòng tiếp theo");
//                Service.getInstance().sendThongBao(loser, "Bạn đã thua vì đã kiệt sức, hãy quay
// lại vào giải sắp tới");
//                break;
//            case PVP.TYPE_LEAVE_MAP:
//                Service.getInstance().sendThongBao(winer, "Đối thủ sợ quá bỏ chạy, bạn thắng được
// đi vào vòng tiếp theo");
